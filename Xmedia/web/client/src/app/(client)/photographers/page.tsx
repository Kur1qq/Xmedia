...
import { ImageIcon, X, ArrowLeft, Calendar as CalendarIcon, Phone, User, Loader2, Info, Check, GalleryVerticalEnd } from "lucide-react";
...
export default function PhotographersPage() {
    ...
    const [form, setForm] = useState({ name: "", phone: "", date: undefined as Date | undefined, time: "", duration: "1" });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setForm({ name: "", phone: "", date: undefined, time: "", duration: "1" });
        } catch {
            toast.error("Захиалга бүртгэхэд алдаа гарлаа.");
        } finally { setSubmitting(false); }
    };

    const close = () => { setSelected(null); setSelectedPackage(null); setIsBooking(false); };
