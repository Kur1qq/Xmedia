    ...
    return (
        <div className="flex flex-col md:flex-row items-center gap-2 p-2 bg-white/95 backdrop-blur-sm border-0 rounded-full shadow-2xl max-w-4xl w-full mx-auto">
            ...
            <div className="relative flex-1 w-full md:w-auto group">
                <Activity className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-hover:text-rose-600 transition-colors" />
                <Input
            ...
            {/* Location Input */}
            <div className="relative flex-1 w-full md:w-auto group">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-hover:text-rose-600 transition-colors" />
                <Input
                    placeholder="Where?"
            ...
            <div className="relative flex-1 w-full md:w-auto group">
                <Popover>
                    <PopoverTrigger asChild>
                        ...
                        >
                            <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 mr-2 text-gray-400 group-hover:text-rose-600 transition-colors" />
            ...
            {/* Search Button */}
            <Button size="lg" className="h-12 w-full md:w-auto px-8 rounded-full bg-rose-600 hover:bg-rose-600/90 text-white font-bold shadow-lg transition-transform hover:scale-105">
